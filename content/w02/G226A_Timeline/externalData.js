// JavaScript Document - G226A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help連結網址 - 後半段
	g226A.helpPath = "g2Help/html/g2Help_g226A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g226A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g226A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g226A
	//----------------------------------------------------------《《《
	g226A.prevNextBtnEdgeOpacity = 0.5; //於最後一頁時，下一頁按鈕的透明度。於第一頁時，上一頁按鈕的透明度。
	g226A.menuZoneOpacity = 1.0; //下拉選單的透明度
	g226A.menuHeader = "《 換頁選單 》"; //下拉選單的標題列文字
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g226A_Timeline/g226A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g226A_Timeline/g226A_Timeline.js";
	//******************************************************************************
	...
	param.libsArr[4] = param.mainPath + "g226A_Timeline/jquery.rwdImageMaps.min.js";
	param.libsArr[5] = param.mainPath + "g226A_Timeline/colorbox/jquery.colorbox-min.js";
	...
	param.cssArr[2] = param.mainPath + "g226A_Timeline/g226A_Overlay.css";
	//******************************************************************************
