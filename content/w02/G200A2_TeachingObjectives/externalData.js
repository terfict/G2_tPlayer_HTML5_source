// JavaScript Document - G200A2│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help連結網址 - 後半段
	g200A2.helpPath = "g2Help/html/g2Help_g200A2/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g200A2.helpPath;
	//---------------------------------------------------------
	//help icon圖檔路徑 - ◎g200A2版型一定要填寫
	param.helpIconPath = "../../CommonG2/g200A2_TeachingObjectives/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - ◎g200A2版型一定要填寫
	param.helpIconOverPath = "../../CommonG2/g200A2_TeachingObjectives/images/help_over.png";
	//---------------------------------------------------------
	...
	//g200A2_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g200A2
	//----------------------------------------------------------《《《
	g200A2.prevNextBtnOpacity = 1.0;
	g200A2.prevNextBtnEdgeOpacity = 0.5;
	//-----------------------------------------------
	g200A2.menuZoneOpacity = 0.95;
	g200A2.menuHeader = "《 換頁選單 》";
	//-----------------------------------------------
	//是否出現數字按鈕 ? - true│false
	g200A2.hasPageBtn = true;
	//----------------------------------------------------------《《《
	//小尺寸視窗是否置換前景圖 ? - true│false
	g200A2.switchForeSmallPicFlag = true;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g200A2_TeachingObjectives/g200A2_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g200A2_TeachingObjectives/g200A2_TeachingObjectives.js";
	//******************************************************************************
