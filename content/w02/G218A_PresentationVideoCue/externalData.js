// JavaScript Document - G218A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.nouMediaIconPath = "../../CommonG2/g218A_PresentationVideoCue/images/nou_media@g210A.png";
	//---------------------------------------------------------
	...
	//g218A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g218A_PresentationVideoCue/g218A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g218A_PresentationVideoCue/g218A_PresentationVideoCue.js";
	//******************************************************************************
	...
	param.cssArr[2] = param.mainPath + "g218A_PresentationVideoCue/g218A_Overlay.css";
	//******************************************************************************
