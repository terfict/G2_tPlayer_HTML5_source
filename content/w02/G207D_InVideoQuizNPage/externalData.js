// JavaScript Document - g207D│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
var g207D =  NOU.namespace('NOU.modules.g207D');
//------------------------
param.G2ID = "g207D";
//------------------------
	...
	//help連結網址 - 後半段
	g207D.helpPath = "g2Help/html/g2Help_g207D/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g207D.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g207D_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g207D_InVideoQuizNPage/g207D_Overlay.js";
	...
	param.jsArr[5] = param.mainPath + "g207D_InVideoQuizNPage/g207D_InVideoQuizNPage.js";
	//******************************************************************************
