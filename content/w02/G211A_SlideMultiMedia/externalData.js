// JavaScript Document - G211A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.helpIconPath = "../../CommonG2/g211A_SlideMultiMedia/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	param.helpIconOverPath = "../../CommonG2/g211A_SlideMultiMedia/images/help_over.png";
	//---------------------------------------------------------
	...
	//g211A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//G211A
	//----------------------------------------------------------《《《
	g211A.prevNextBtnOpacity = 0.7;
	g211A.prevNextBtnEdgeOpacity = 0.3;
	g211A.menuZoneOpacity = 0.95;
	g211A.menuHeader = "《 換頁選單 》";
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g211A_SlideMultiMedia/g211A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g211A_SlideMultiMedia/g211A_SlideMultiMedia.js";
	//******************************************************************************
