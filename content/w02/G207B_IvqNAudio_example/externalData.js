// JavaScript Document - G207B│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//●G207B版型，影音在此設為streaming。
	//●語音需在下方g207B.chooseSreamingOrLocalAudio設為local，在行動裝置才能順利播放利播放。
	...
	//help連結網址 - 後半段
	g207B.helpPath = "g2Help/html/g2Help_g207B/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g207B.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g207B_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//----------------------------------------------------------《《《
	g207B.audioAutoPlay = true;
	//----------------------------------------------------------《《《
	
	
	//●語音來源必須另設為local端 (影音則在上方設定為streaming)。
	//----------------------------------------------------------《《《
	g207B.chooseSreamingOrLocalAudio = 'local'; //●G207B版型的語音此屬性必為'local'。
	//----------------------------------------------------------《《《
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g207B_IvqNAudio/g207B_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g207B_IvqNAudio/tPlayer_QuizB.js"; 
	param.jsArr[5] = param.mainPath + "g207B_IvqNAudio/g207B_IvqNAudio.js";
	//******************************************************************************
