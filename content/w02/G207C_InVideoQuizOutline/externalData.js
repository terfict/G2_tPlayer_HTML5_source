// JavaScript Document - G207C│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
var g207C =  NOU.namespace('NOU.modules.g207C');
//------------------------
param.G2ID = "G207C";
//------------------------
	...
	param.pauseDelayTime = 500; //●以毫秒(ms)為單位。500為預設值。不要修改此値。
	...
	//help連結網址 - 後半段
	g207C.helpPath = "g2Help/html/g2Help_g207/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g207C.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g207C_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g207C_InVideoQuizOutline/g207C_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "tPlayer/tPlayer_Quiz.js";
	param.jsArr[5] = param.mainPath + "g207C_InVideoQuizOutline/g207C_InVideoQuizOutline.js";
	//******************************************************************************
