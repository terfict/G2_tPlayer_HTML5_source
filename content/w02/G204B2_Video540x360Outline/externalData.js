// JavaScript Document - G204B2│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.pauseDelayTime = 250; //●以毫秒(ms)為單位。250為預設值。
	...
	//help連結網址 - 後半段
	g204B2.helpPath = "g2Help/html/g2Help_g204B/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g204B2.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g204B2_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	param.bgScope2Img_definedHeight[0] = ['top',30];  //◎G204B2版型：程式決策：視窗大於斷點採用['top',30]
	//-----------------------------------------------
	...
	//param.bgScope2Img_definedHeight[0] = ['follow_middle'];  //◎G204B2版型：程式決策：視窗小於斷點採用['follow_middle']
	//==========================================================
	//「點小圖放大圖」之大圖 x位置 微調參數
	...
	//重點文字區塊.g204B2_outlineWrapper的向左位移數值。(重點文字區塊的寬度或初始位置不變的話，就不需修改)
	g204B2.outlineOffset = 374;
	
	//重點文字區塊.g204B2_outlineWrapper的初始位置。
	//新增使用此參數原因：因iPad以旭聯APP進入，G204B2版型讀取.g204B2_outlineWrapper的left屬性值，遭APP干擾，變成NaN
	g204B2.outlineWrapperIniX = 820;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g204B2_Video540x360Outline/g204B2_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g204B2_Video540x360Outline/g204B2_Video540x360Outline.js";
	//******************************************************************************
