// JavaScript Document - G224A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.chooseSreamingOrLocalVideo = "local"; //●1060905 - G224A版型，必須設為local。語音在行動裝置才能順利播放。
	...
	//help連結網址 - 後半段
	g224A.helpPath = "g2Help/html/g2Help_g224A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g224A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g224A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g224A_quiz/g224A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g224A_quiz/tPlayer_QuizD.js"; 
	param.jsArr[5] = param.mainPath + "g224A_quiz/g224A_quiz.js";
	//******************************************************************************
