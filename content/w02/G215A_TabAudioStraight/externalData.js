// JavaScript Document - G215A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help icon圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	param.helpIconPath = "";
	//help icon滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	...
	//g215A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g215A
	//----------------------------------------------------------《《《
	g215A.prevNextBtnOpacity = 0.9; //下一頁、上一頁按鈕的透明度
	g215A.prevNextBtnEdgeOpacity = 0.3; //於最後一頁時，下一頁按鈕的透明度。於第一頁時，上一頁按鈕的透明度。
	g215A.menuZoneOpacity = 0.95; //下拉選單的透明度
	g215A.menuHeader = "《 換頁選單 》"; //下拉選單的標題列文字
	g215A.tabMinNumControlContentHeight = 6; //頁籤按鈕數量最少為多少時，需控制.g215A_content的高度
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g215A_TabAudioStraight/g215A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g215A_TabAudioStraight/g215A_TabAudioStraight.js";
	//******************************************************************************
