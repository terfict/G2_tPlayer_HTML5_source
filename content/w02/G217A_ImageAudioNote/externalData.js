// JavaScript Document - G217A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//---------------------------------------------------------
	//help icon圖檔路徑 - ◎G217A版型一定要填寫
	param.helpIconPath = "../../CommonG2/g217A_ImageAudioNote/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - ◎G217A版型一定要填寫
	param.helpIconOverPath = "../../CommonG2/g217A_ImageAudioNote/images/help_over.png";
	//---------------------------------------------------------
	...
	//g217A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g217A
	//----------------------------------------------------------《《《
	g217A.prevNextBtnOpacity = 1.0;
	g217A.prevNextBtnEdgeOpacity = 0.5;
	//-----------------------------------------------
	g217A.menuZoneOpacity = 0.95;
	g217A.menuHeader = "《 換頁選單 》";
	//-----------------------------------------------
	//是否出現數字按鈕 ? - true│false
	g217A.hasPageBtn = true;
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g217A_ImageAudioNote/g217A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g217A_ImageAudioNote/g217A_ImageAudioNote.js";
	//******************************************************************************
