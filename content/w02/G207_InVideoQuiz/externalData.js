// JavaScript Document - G207│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//g207_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	param.breakpoint = 735;
	//-----------------------------------------------
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g207_InVideoQuiz/g207_Overlay.js";
	...
	param.jsArr[5] = param.mainPath + "g207_InVideoQuiz/g207_InVideoQuiz.js";
	//******************************************************************************
