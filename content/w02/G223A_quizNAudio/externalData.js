// JavaScript Document - G223A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.chooseSreamingOrLocalVideo = "streaming"; //●G223A版型僅有語音。
	//●G223A版型，此處的streaming當做預設值，但會被下面G223A.chooseSreamingOrLocalAudio所覆蓋。
	//●G223A版型，語音需在下方G223A.chooseSreamingOrLocalAudio設為local，在行動裝置才能順利播放。
	...
	param.pauseDelayTime = 800; //●以毫秒(ms)為單位。500為預設值。不要修改此値。
	param.pauseDelayTimeH5 = 500; //param.pauseDelayTimeH5暫時沒用到。
	//----------------------------------------------------------《《《
	...
	//help連結網址 - 後半段
	g223A.helpPath = "g2Help/html/g2Help_g223A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g223A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g223A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//●只能設為false。 ●若設為true語音自動播放，暫停答題時，按下【繼續播放】，會卡在暫停點，不能順暢繼續播放。可能是影音和語音有所衝突。
	//●1060905 - 因應長官指示，需改為進入頁面，延遲2秒，自動播放語音。並解決卡在暫停點的問題。(不卡了)
	//----------------------------------------------------------《《《
	g223A.audioAutoPlay = true;
	//----------------------------------------------------------《《《
	
	
	//●語音來源必須另設為local端 (影音則在上方設定為streaming)。
	//----------------------------------------------------------《《《
	g223A.chooseSreamingOrLocalAudio = 'local'; //●g223A版型的語音此屬性必為'local'。
	//----------------------------------------------------------《《
	param.chooseSreamingOrLocalAudio = g223A.chooseSreamingOrLocalAudio;
	...
	//G2核心+版型主程式
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g223A_quizNAudio/g223A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g223A_quizNAudio/tPlayer_QuizC.js"; 
	param.jsArr[5] = param.mainPath + "g223A_quizNAudio/g223A_quizNAudio.js";
	//******************************************************************************
