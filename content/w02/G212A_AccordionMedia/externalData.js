// JavaScript Document - G212A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//g212A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g212A
	//----------------------------------------------------------《《《
	g212A.prevNextBtnOpacity = 1.0; //「向左按鈕」、「向右按鈕」的透明度
	g212A.prevNextBtnEdgeOpacity = 0.3; //「向左按鈕在第1頁時」與「向又按鈕在最後一頁時」的透明度
	g212A.menuZoneOpacity = 0.95; //左上角的選單按鈕所開啟的選單區塊的透明度
	g212A.menuHeader = "《 換頁選單 》";
	g212A.promptMessageStr = " 請點選下列項目按鈕，瀏覽教材。"; 
	g212A.openFirstPage = true; //進入頁面時，是否開啟第一頁 - true│false
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g212A_AccordionMedia/g212A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g212A_AccordionMedia/g212A_AccordionMedia.js";
	//******************************************************************************
