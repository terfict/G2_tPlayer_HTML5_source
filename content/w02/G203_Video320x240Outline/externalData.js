// JavaScript Document - G203│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//g203_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	param.bgScope2Img_definedHeight[0] = ['top',30];  //◎G203版型：程式決策：視窗大於斷點採用['top',30]
	//-----------------------------------------------
	...
	//param.bgScope2Img_definedHeight[0] = ['follow_middle'];  //◎G203版型：程式決策：視窗小於斷點採用['follow_middle']
	//==========================================================
	//「點小圖放大圖」之大圖 x位置 微調參數
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g203_Video320x240Outline/g203_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g203_Video320x240Outline/g203_Video320x240Outline.js";
	//******************************************************************************
