// JavaScript Document - G200A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help連結網址 - 後半段
	g200A.helpPath = "g2Help/html/g2Help_g200A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g200A.helpPath;
	//---------------------------------------------------------
	//help icon圖檔路徑 - ◎g200A版型一定要填寫
	param.helpIconPath = "../../CommonG2/g200A_TeachingObjectives/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - ◎g200A版型一定要填寫
	param.helpIconOverPath = "../../CommonG2/g200A_TeachingObjectives/images/help_over.png";
	//---------------------------------------------------------
	...
	//g200A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g200A
	//----------------------------------------------------------《《《
	g200A.prevNextBtnOpacity = 1.0;
	g200A.prevNextBtnEdgeOpacity = 0.5;
	//-----------------------------------------------
	g200A.menuZoneOpacity = 0.95;
	g200A.menuHeader = "《 換頁選單 》";
	//-----------------------------------------------
	//是否出現數字按鈕 ? - true│false
	g200A.hasPageBtn = true;
	//----------------------------------------------------------《《《
	//小尺寸視窗是否置換前景圖 ? - true│false
	g200A.switchForeSmallPicFlag = true;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g200A_TeachingObjectives/g200A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g200A_TeachingObjectives/g200A_TeachingObjectives.js";
	//******************************************************************************
