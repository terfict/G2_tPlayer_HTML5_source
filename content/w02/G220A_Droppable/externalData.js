// JavaScript Document - G220A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.chooseSreamingOrLocalVideo = "streaming"; //●G220A版型僅有語音。
	//●G220A版型，此處的streaming當做預設值，但會被下面G220A.chooseSreamingOrLocalAudio所覆蓋。
	//●G220A版型，語音需在下方G220A.chooseSreamingOrLocalAudio設為local，在行動裝置才能順利播放。
	...
	param.nouMediaIconPath = "../../CommonG2/g220A_droppable/images/nou_media@g210A.png";
	//---------------------------------------------------------
	...
	//help連結網址 - 後半段
	g220A.helpPath = "g2Help/html/g2Help_g220A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g220A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g220A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	g220A.usingRandomNumbers = true;
	
	
	//●語音來源必須另設為local端 (影音則在上方設定為streaming)。
	//----------------------------------------------------------《《《
	g220A.chooseSreamingOrLocalAudio = 'local'; //●g220A版型的語音此屬性必為'local'。
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g220A_droppable/g220A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g220A_droppable/g220A_droppable.js";
	//******************************************************************************
	...
	param.cssArr[2] = param.mainPath + "g220A_droppable/g220A_Overlay.css";
	//******************************************************************************
