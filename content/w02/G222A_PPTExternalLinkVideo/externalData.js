// JavaScript Document - G222A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help連結網址 - 後半段
	g222A.helpPath = "g2Help/html/g2Help_g222A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g222A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g222A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g222A_PPTExternalLinkVideo/g222A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g222A_PPTExternalLinkVideo/g222A_PPTExternalLinkVideo.js";
	//******************************************************************************
