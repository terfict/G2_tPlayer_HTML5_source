// JavaScript Document - G214A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.helpIconPath = "../../CommonG2/g214A_MultiPageAudio/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	param.helpIconOverPath = "../../CommonG2/g214A_MultiPageAudio/images/help_over.png";
	//---------------------------------------------------------
	...
	//g214A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g214A
	//----------------------------------------------------------《《《
	g214A.prevNextBtnOpacity = 0.7;
	g214A.prevNextBtnEdgeOpacity = 0.3;
	g214A.menuZoneOpacity = 0.95;
	g214A.menuHeader = "《 換頁選單 》";
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g214A_MultiPageAudio/g214A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g214A_MultiPageAudio/g214A_MultiPageAudio.js";
	//******************************************************************************
