// JavaScript Document - G206│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.nouMediaIconPath = "../../CommonG2/g206_ScreenRecordVideo1024x768/images/nou_media.png";
	//---------------------------------------------------------
	...
	param.notebookIconPath = "../../CommonG2/g206_ScreenRecordVideo1024x768/images/notebook.png";
	//notebook滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS/images/目錄內抓圖
	param.notebookIconOverPath = "../../CommonG2/g206_ScreenRecordVideo1024x768/images/notebook_over.png";
	//---------------------------------------------------------
	...
	param.helpIconPath = "../../CommonG2/g206_ScreenRecordVideo1024x768/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS/images/目錄內抓圖
	param.helpIconOverPath = "../../CommonG2/g206_ScreenRecordVideo1024x768/images/help_over.png";
	//---------------------------------------------------------
	//媒體介面是否有進場jQ動作 ? - true│false
	param.hasEnteringMotion = true;
	//---------------------------------------------------------
	//G206在行動裝置上，當寬高為1024x768，是否改為800x600 ? - true│false
	param.change1024x768To800x600OnMobile = false;
	//----------------------------------------------------------《《《
	...
	//g206_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g206_ScreenRecordVideo1024x768/g206_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g206_ScreenRecordVideo1024x768/g206_ScreenRecordVideo1024x768.js";
	//******************************************************************************
