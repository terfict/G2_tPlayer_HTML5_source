// JavaScript Document - G200A3│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//NOU_Media Icon圖檔連結路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	...
	//notebook圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	param.notebookIconPath = "";
	//notebook滑鼠over其上的圖檔路徑 - 若留空白，會到tPlayer_CSS目錄內抓圖
	...
	//help連結網址 - 後半段
	g200A3.helpPath = "g2Help/html/g2Help_g200A3/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g200A3.helpPath;
	//---------------------------------------------------------
	//help icon圖檔路徑 - ◎g200A3版型一定要填寫
	param.helpIconPath = "../../CommonG2/g200A3_TeachingObjectives/images/help.png";
	//help icon滑鼠over其上的圖檔路徑 - ◎g200A3版型一定要填寫
	param.helpIconOverPath = "../../CommonG2/g200A3_TeachingObjectives/images/help_over.png";
	//---------------------------------------------------------
	...
	//g200A3_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	param.bgScope2Img_definedHeight[0] = ['follow',-20];
	//-----------------------------------------------
	...
	//-----------------------------------------------
	//「點小圖放大圖」：●「.toBigPic > img」 圖形在小尺寸視窗時，排版寬度(未放大的狀態)
	...
	//g200A3
	//----------------------------------------------------------《《《
	g200A3.prevNextBtnOpacity = 1.0;
	g200A3.prevNextBtnEdgeOpacity = 0.5;
	//-----------------------------------------------
	g200A3.menuZoneOpacity = 0.95;
	g200A3.menuHeader = "《 換頁選單 》";
	//-----------------------------------------------
	//是否出現數字按鈕 ? - true│false
	g200A3.hasPageBtn = true;
	//----------------------------------------------------------《《《
	//小尺寸視窗是否置換前景圖 ? - true│false
	g200A3.switchForeSmallPicFlag = true;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g200A3_TeachingObjectives/g200A3_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g200A3_TeachingObjectives/g200A3_TeachingObjectives.js";
	//******************************************************************************
