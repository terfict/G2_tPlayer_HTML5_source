// JavaScript Document - G204B│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//g204B_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	param.bgScope2Img_definedHeight[0] = ['top',30];  //◎G204B版型：程式決策：視窗大於斷點採用['top',30]
	//-----------------------------------------------
	...
	//param.bgScope2Img_definedHeight[0] = ['follow_middle'];  //◎G204B版型：程式決策：視窗小於斷點採用['follow_middle']
	//==========================================================
	//「點小圖放大圖」之大圖 x位置 微調參數
	...
	//重點文字區塊.g204B_outlineWrapper的向左位移數值。(重點文字區塊的寬度或初始位置不變的話，就不需修改)
	g204B.outlineOffset = 374;
	
	//重點文字區塊.g204B_outlineWrapper的初始位置。
	//新增使用此參數原因：因iPad以旭聯APP進入，G204B版型讀取.g204B_outlineWrapper的left屬性值，遭APP干擾，變成NaN
	g204B.outlineWrapperIniX = 820;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g204B_Video640x360Outline/g204B_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g204B_Video640x360Outline/g204B_Video640x360Outline.js";
	//******************************************************************************
