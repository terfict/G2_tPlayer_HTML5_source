// JavaScript Document - G208│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.nouMediaIconPath = "../../CommonG2/g208_Audio/images/nou_media.png";
	//---------------------------------------------------------
	...
	//g208_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g208_Audio/g208_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g208_Audio/g208_Audio.js";
	//******************************************************************************
