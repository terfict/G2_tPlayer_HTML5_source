// JavaScript Document - G211B│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//g211B_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//g211B
	//----------------------------------------------------------《《《
	g211B.prevNextBtnOpacity = 0.7;
	g211B.prevNextBtnEdgeOpacity = 0.3;
	g211B.menuZoneOpacity = 0.95;
	g211B.menuHeader = "《 換頁選單 》";
	//----------------------------------------------------------《《《
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g211B_SlideMultiMedia/g211B_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g211B_SlideMultiMedia/g211B_SlideMultiMedia.js";
	//******************************************************************************
