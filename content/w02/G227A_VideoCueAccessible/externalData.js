// JavaScript Document - G227A│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.nouMediaIconPath = "../../CommonG2/g227A_VideoCueAccessible/images/nou_media.png";
	//---------------------------------------------------------
	...
	//help連結網址 - 後半段
	g227A.helpPath = "g2Help/html/g2Help_g227A/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g227A.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g227A_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//播放頭搜尋到cuepoint時，附加的位移微調數値。需要時才修改(不用改了)。此例(承襲G213A的設定)，增加0.1秒，避免播放頭seeking先進入前一個區段的尾端。
	g227A.seekFineTuning = 0.1; 
	
	//寬度比例變動時，計算寬度時所加入的微調數値。
	g227A.widthOffset = 1;

	
	//字級放大調整最大值
	param.fontSizeOffsetMax = 48; //tPlayer.js原為 8
	//字級縮小調整最小值
	param.fontSizeOffsetMin = -6;
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g227A_VideoCueAccessible/g227A_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g227A_VideoCueAccessible/g227A_VideoCueAccessible.js";
	//******************************************************************************
	...
	param.cssArr[2] = param.mainPath + "g227A_VideoCueAccessible/g227A_Overlay.css";
	//******************************************************************************
