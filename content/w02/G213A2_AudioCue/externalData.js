// JavaScript Document - G213A2│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	param.nouMediaIconPath = "../../CommonG2/g213A2_AudioCue/images/nou_media@g210A.png";
	//---------------------------------------------------------
	...
	//help連結網址 - 後半段
	g213A2.helpPath = "g2Help/html/g2Help_g213A2/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g213A2.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g213A2_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//播放頭搜尋到cuepoint時，附加的位移微調數値。需要時才修改。此例，增加0.1秒，避免播放頭seeking先進入前一個區段的尾端。
	g213A2.seekFineTuning = 0.1; 
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g213A2_AudioCue/g213A2_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g213A2_AudioCue/g213A2_AudioCue.js";
	//******************************************************************************
	...
	param.cssArr[2] = param.mainPath + "g213A2_AudioCue/g213A2_Overlay.css";
	//******************************************************************************
