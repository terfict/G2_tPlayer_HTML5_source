// JavaScript Document - G217B│externalData.js
//-----------------------------------------------------
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	//help連結網址 - 後半段
	g217B.helpPath = "g2Help/html/g2Help_g217B/index.html";
	//help連結網址 - 完整
	param.helpUrl = param.helpUrlRoot + g217B.helpPath;
	//---------------------------------------------------------
	//「新手上路」alt註解文字
	...
	//g217B_Overlay.css最下方的[Media Query]所設的斷點數值 必須和這裏一致。
	...
	//******************************************************************************
	param.jsArr = [];
	param.jsArr[0] = param.mainPath + "g217B_ImageAudioNote/g217B_Overlay.js";
	...
	param.jsArr[4] = param.mainPath + "g217B_ImageAudioNote/g217B_ImageAudioNote.js";
	//******************************************************************************
