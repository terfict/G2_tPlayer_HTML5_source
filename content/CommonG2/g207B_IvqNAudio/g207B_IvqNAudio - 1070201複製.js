	...
	//●○//=================================================
		...
		//●○//=================================================
			...
			if( $('.quizSet:eq(' + quizSetIndex + ') .quizzing:eq(' + quizzingIndex +') .addVoice').get(0) !== undefined ){
				...
				//●●●記錄哪些quizSetIndex、quizzingIndex有加入語音檔
				//=============================================================================
		...
		if( index === 0 ){
			...
			if( !utils.isMobile ){ 
				...
				setTimeout(function(){
					//
					//==============================================《●》
					param.chooseSreamingOrLocalVideo = g207B.chooseSreamingOrLocalAudio; //g207B.chooseSreamingOrLocalAudio在externalData.js設定為'local'。
					urlObj = method.getStreamingData(index);
					//==============================================《●》
