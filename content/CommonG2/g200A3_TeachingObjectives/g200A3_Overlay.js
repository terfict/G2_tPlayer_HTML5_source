// JavaScript Document - G200A3│g200A3_Overlay.js
////////////////////////////////////////////////////////
/******************************************************/
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	method.rwdCss = function(){
		...
		$('.g200A3_headerStringOuter').css({
		});
		$('.g200A3_headerString').css({
			'padding':'3px 12px 3px 0px',
			'font-size':'1.0em'
		});
		
		//
		$('.g200A3_rwdNavDiv').css({
			'display':'table',
			'display':'none',
			'width':'100%',
			'height':'auto',
		...
		$('.textPhoto').css({
			'background':'url(' + param.mainPath + 'g200A3_TeachingObjectives/images/G200A3_bg_rwd.png)'
		});
		$('.textPhoto .inner').css({
		});
	...
	method.normalCss = function(){
		...
		$('.textPhoto').css({
			'background':'url(' + param.mainPath + 'g200A3_TeachingObjectives/images/G200A3_bg.png)'
		});
		$('.textPhoto .inner').css({
		});
		$('.textPhoto .inner .title').css({
		...
		$('.g200A3_help').css({'display':'inline-block'});
