// JavaScript Document - G200A2│g200A2_Overlay.js
////////////////////////////////////////////////////////
/******************************************************/
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	method.rwdCss = function(){
		...
		$('.g200A2_headerStringOuter').css({
		});
		$('.g200A2_headerString').css({
			'padding':'3px 12px 3px 0px',
			'font-size':'1.0em'
		});
		
		//
		$('.g200A2_rwdNavDiv').css({
			'display':'table',
			'display':'none',
			'width':'100%',
			'height':'auto',
		...
		$('.textPhoto').css({
			'background':'url(' + param.mainPath + 'g200A2_TeachingObjectives/images/G200A2_bg_rwd.png)'
		});
		$('.textPhoto .inner').css({
		});
	...
	method.normalCss = function(){
		...
		$('.textPhoto').css({
			'background':'url(' + param.mainPath + 'g200A2_TeachingObjectives/images/G200A2_bg.png)'
		});
		$('.textPhoto .inner').css({
		});
		$('.textPhoto .inner .title').css({
		...
		$('.g200A2_help').css({'display':'inline-block'});
