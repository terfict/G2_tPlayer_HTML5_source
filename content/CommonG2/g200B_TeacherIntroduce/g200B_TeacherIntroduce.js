// JavaScript Document - G200B│g200B_WebTextPhoto.js
////////////////////////////////////////////////////////
/******************************************************/
var NOU = NOU || {};
//-----------------------------------------------------
...
$(window).on('resize', function(){
	...
	if( $(window).width() > param.breakpoint ){ //alert($('.insertPic').hasClass('item_pic'));
		...
		if( $('.tr_name .insertPic .teacherPicTable').get(0) !== undefined ){
			...
			$('.tr_name .item_name').html( g200B.itemName );
			$('.tr_name .item_value').html( g200B.itemValue );
	...
	//小尺寸視窗
		...
		if( $('.tr_name .insertPic .teacherPicTable').get(0) === undefined ){
			...
			$('.tr_name .item_name').html( g200B.itemValue );
...
$(document).ready(function(){
	...
	//===================================
	g200B.itemName = $('.tr_name .item_name').text();
	g200B.itemValue = $('.tr_name .item_value').text();
	//===================================
