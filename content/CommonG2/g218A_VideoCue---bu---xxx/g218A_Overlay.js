// JavaScript Document - G218A│g218A_Overlay.js
////////////////////////////////////////////////////////
/******************************************************/
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	method.rwdCss = function(){
		...
		$('.g218A_cardGroupShow').css({
			'width':'100%',
			'margin-bottom':'0px auto -10px auto'
		});
		
		//
		$('.g218A_minus_plus').css({
			'display':'none'
		});
		
		//
		$('.g218A_controlBar').css({
			'display':'none'
		});
		...
		$('.g218A_numButtonGroup').css({
			'width':'100%',
			/*●margin-top設為-10px：因在小視窗，.g218A_cardGroupShow和.g218A_numButtonGroup之間會出現水平間隙，補救用*/
			'margin':'-10px auto 0 auto'  //原css為margin:0 auto 0 auto
		});
		
		$('.g218A_showCueTitle').css({
			'width':'100%'
		});
