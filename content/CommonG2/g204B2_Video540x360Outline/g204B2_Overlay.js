// JavaScript Document - G204B2│g204B2_Overlay.js
////////////////////////////////////////////////////////
/******************************************************/
var NOU = NOU || {};
//-----------------------------------------------------
...
//------------------------
	...
	method.rwdCss = function(){
		...
		$('.g204B2_subtitle').css({'margin':'-10px 0px 5px 5px'});
	...
	method.normalCss = function(){
		...
		$('.g204B2_outlineWrapper').css({
			...
			'height':'405px',
			'display':'none',
			'background':'url(' + param.mainPath + 'g204B2_Video640x360Outline/images/outlineZoneBg.png) no-repeat'
		});
		$('.g204B2_outline').css({
		...
		$('.g204B2_subtitle').css({'margin':':0px 0px 12px 5px'});
