package terfict {
	...
	public class tPlayer extends Sprite {
		...
		private function addedToStage(event: Event): void {
			...
			//this.stage.addEventListener(MouseEvent.DOUBLE_CLICK, normalFullScreenHandler);
		...
		private function jsReadyMethod(): void {
			...
			//this.addEventListener(MouseEvent.MOUSE_OVER,mouseMoveHandler);
		...
		public function addCallbackForJS(): void {
			...
			ExternalInterface.addCallback("as3_stageScaleModeToNoScale", as3_stageScaleModeToNoScale);
			ExternalInterface.addCallback("as3_stageScaleModeToExactFit", as3_stageScaleModeToExactFit);
		...
		private function connectStream(): void {
			...
			//●●●●●●//@影音寬高設定於此 -- 影音原始寬高在onMetaDataHandler()擷取
			//==================================================================
			//
		...
		//1041103
		private function as3_stageScaleModeToNoScale():void {
			//this.stage.scaleMode = StageScaleMode.NO_SCALE;
		}
		
		//1041103
		private function as3_stageScaleModeToExactFit():void {
		...
		//@@@ 1041030
		private function normalFullScreenHandler(event:MouseEvent):void {
			if(this.stage.displayState == StageDisplayState.NORMAL){
				...
				//1041104
				/*var pbContainer:MovieClip = new PbContainer();
				this.addChild(pbContainer);
				pbContainer.x = 0;
				pbContainer.y = 100;*/
