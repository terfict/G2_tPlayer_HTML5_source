...
//========↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
//●○●○●○1060725-修改●○●○●○ - 用來播放 影音(InVideoQuiz)
...
function initBtnState(index){
	...
	if( utils.isMobile && utils.isAndroid ){
...
function playBtnState(index){
	...
	$('.playBtn img').css({'opacity':1.0})
		...
		.on('mouseover',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_playBtn_over.png');
		})
		.on('mouseout',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_playBtn.png');
		})
		
		.on('mousedown', function(){ 
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_playBtn.png').css({'opacity':0.5});
...
function pauseBtnState(index){
	...
	$('.pauseBtn img').css({'opacity':1.0})
		.on('mouseover',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_pauseBtn_over.png');
		})
		.on('mouseout',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_pauseBtn.png');
		})
		
		.on('mousedown', function(){ 
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_pauseBtn.png').css({'opacity':0.5});
...
function stopBtnState(index){
	...
	$('.stopBtn img').css({'opacity':1.0})
		.on('mouseover',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_stopBtn_over.png');
		})
		.on('mouseout',function(){
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_stopBtn.png');
		})
		
		.on('mousedown', function(){ 
			$(this).attr('src',param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_stopBtn.png').css({'opacity':0.5});
			...
			if( param.ivqHasMediaArr[index][1] === _currentQuiz ){
				...
				var htmlStr = 
					...
					'<div class="btnWrapper">'+
						'<span class="playBtn"><img src="' + param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_playBtn.png" alt="play按鈕"></span>'+
						'<span class="pauseBtn"><img src="' + param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_pauseBtn.png" alt="pause按鈕"></span>'+
						'<span class="stopBtn"><img src="' + param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_stopBtn.png" alt="stop按鈕"></span>'+
					'</div>'+
					'</div>';
				...
				//alert(param.mainPath + 'g207B_InVideoQuiz/images/simplePlayer_stopBtn.png');
